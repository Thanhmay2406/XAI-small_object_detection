"""Diagnostic-only script for activation-guided FPN scale diagnosis.
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Diagnostic-only XAI-guided FPN scale selection analysis."
    )
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("artifacts/fpn_activation_diagnosis"),
